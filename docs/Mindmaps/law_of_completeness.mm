...
<node CREATED="1232278495091" ID="ID_217096451" MODIFIED="1232287046399" STYLE="bubble" TEXT="Law Of Completeness">
<node CREATED="1232287082499" ID="ID_454728814" MODIFIED="1232287198118" POSITION="right" TEXT="INFO">
<icon BUILTIN="idea"/>
<node CREATED="1232286990454" ID="ID_1902108158" MODIFIED="1232287058411" TEXT="is the link between temporal and Boolean &#xa;conjunctions (AND, PAND, SAND terms)">
<icon BUILTIN="idea"/>
</node>
<node CREATED="1232286944067" ID="ID_776243739" MODIFIED="1232287058420" TEXT="AND[ X,Y ] = XOR[ PAND[ X,Y ], SAND[ X,Y ], PAND[ Y,X ] ]">
<icon BUILTIN="idea"/>
</node>
</node>
...
<node CREATED="1232280396321" ID="ID_1614376752" MODIFIED="1232283296647" STYLE="bubble" TEXT="separated as easy to check">
<icon BUILTIN="info"/>
</node>
</node>
...
<node CREATED="1232283217366" ID="ID_236527498" MODIFIED="1232283296641" TEXT="as negated operands of commutative terms &#xa;are &quot;sorted&quot; to the beginning of the term, it &#xa;is sufficient to check the first operand!">
<icon BUILTIN="info"/>
</node>
</node>
...
<icon BUILTIN="messagebox_warning"/>
<node CREATED="1232278999209" ID="ID_1035002355" MODIFIED="1232283342103" STYLE="bubble" TEXT="if more than two operands:&#xa;split into two operands (using ANDSplit)">
<icon BUILTIN="info"/>
</node>
...
<node CREATED="1232280133339" ID="ID_1116805443" MODIFIED="1232282866028" STYLE="bubble" TEXT="if flag &quot;alsoBasics&quot; is not set then">
<icon BUILTIN="help"/>
...
<icon BUILTIN="messagebox_warning"/>
<node CREATED="1232278999209" ID="ID_813306124" MODIFIED="1232283342097" STYLE="bubble" TEXT="if more than two operands:&#xa;split into two operands (using ANDSplit)">
<icon BUILTIN="info"/>
</node>
